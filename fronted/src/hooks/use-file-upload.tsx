...
{/* FIXME  MC80OmFIVnBZMlhsc0xubHVKM21vYVk2VVRGak1BPT06YzRiYjY3MjM= */}
...
{/* FIXME  MS80OmFIVnBZMlhsc0xubHVKM21vYVk2VVRGak1BPT06YzRiYjY3MjM= */}
  ...
  useEffect(() => {
    ...
    const handleWindowDrop = async (e: DragEvent) => {
      ...
      const newBlocks = uniqueFiles.length
        ? await Promise.all(uniqueFiles.map(fileToContentBlock))
        : [];
{/* @ts-ignore  Mi80OmFIVnBZMlhsc0xubHVKM21vYVk2VVRGak1BPT06YzRiYjY3MjM= */}
...
{/* FIXME  My80OmFIVnBZMlhsc0xubHVKM21vYVk2VVRGak1BPT06YzRiYjY3MjM= */}
